  ...
  return (
    <div className="shagi-app-shell shagi-app-shell--desktop">
      ...
      <main className="shagi-app-shell__main">
        {/* Никаких `key`-ремоунтов: экраны сами перечитывают данные по
         * `dataVersion` (`state/store.ts`), и их состояние — прокрутка,
         * раскрытые группы, режим выбора — при правке в панели не
         * теряется. Перемонтирование как механизм обновления было бы
         * заметно человеку. */}
