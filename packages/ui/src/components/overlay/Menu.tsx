 ...
 * destructive-пункт снизу — жирный, красный текст (`var(--red-500)`, не
 * `var(--destructive)` — см. `Menu.css`/`colors.css`: `--destructive` как
 * текст на `--popover` не проходил WCAG AA, а зафиксирован SPEC и занят
 * ролью фона в других местах). Компонент не
